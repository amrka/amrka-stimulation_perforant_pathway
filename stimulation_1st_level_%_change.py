...
templates = {
    ...
    'tem2anat': '/media/amr/Amr_4TB/Work/stimulation/Stimulation_Preproc_WorkingDir/stimulation_preproc/_subject_id_{subject_id}/reg_T1_2_temp/transform_InverseWarped.nii.gz',
