...
templates = {
    ...
    'zstat':  '//home/in/aeed/Work/stimulation/stimulation_3rd_level/{frequencies}/flameo/{zstats}.nii.gz',
...
def smooth_est(zstat):
    ...
    if zstat[-25:-21] == '10Hz':
        res4d = '/home/in/aeed/Work/stimulation/stimulation_3rd_level/10Hz/flameo/res4d.nii.gz'
        smooth_est.inputs.dof = 7
    elif zstat[-25:-21] == '20Hz':
        res4d = '/home/in/aeed/Work/stimulation/stimulation_3rd_level/20Hz/flameo/res4d.nii.gz'
        smooth_est.inputs.dof = 7
    elif zstat[-25:-21] == '40Hz':
        res4d = '/home/in/aeed/Work/stimulation/stimulation_3rd_level/40Hz/flameo/res4d.nii.gz'
...
def cluster_zstats(zstat, volume, dlh):
    ...
    if zstat[-25:-21] == '10Hz':
        cope = '/home/in/aeed/Work/stimulation/stimulation_3rd_level/10Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
    elif zstat[-25:-21] == '20Hz':
        cope = '/home/in/aeed/Work/stimulation/stimulation_3rd_level/20Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
    elif zstat[-25:-21] == '40Hz':
        cope = '/home/in/aeed/Work/stimulation/stimulation_3rd_level/40Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
...
proc_3rd_level.run(plugin='SLURM', plugin_args={
