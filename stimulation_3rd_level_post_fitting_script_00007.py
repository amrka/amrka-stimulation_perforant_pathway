...
def cluster_zstats(zstat, volume, dlh):
    ...
    if zstat[-25:-21] == '10Hz':
        cope = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level/10Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
    elif zstat[-25:-21] == '20Hz':
        cope = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level/20Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
    elif zstat[-25:-21] == '40Hz':
        cope = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level/40Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
